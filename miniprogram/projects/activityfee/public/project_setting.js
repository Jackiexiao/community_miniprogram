module.exports = { //activityfee
	...
	USER_CHECK_FORM: {
		...
		realName: 'formRealName|must|string|min:2|max:30|name=真实姓名',
		mobile: 'formMobile|must|mobile|name=手机',
		pic: 'formPic|must|string|name=头像',
		gender: 'formGender|must|int|in:0,1,2|name=性别',
		city: 'formCity|must|string|min:2|max:50|name=城市',
		desc: 'formDesc|must|string|min:10|max:500|name=自我介绍',
		resource: 'formResource|string|max:500|name=可分享资源',
		needs: 'formNeeds|string|max:500|name=需求',
